...
<html>
  ...
  <body>
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center">
        <div id="stbo-app"></div>
        <div style="font-size: 12px">Generated by <a href="https://github.com/zoni-code/Z2StripBreakout" target="_blank" rel="noopener">Z2StripBreakout</a> version ${VERSION}</div>
    </div>
